...
var InboxReaderComponent = /** @class */ (function () {
    ...
    InboxReaderComponent.prototype.GetTopRank = function () {
        ...
        var dem = 0;
        var intervalSapXep = setInterval(function () {
            _this.inboxReaderService.getTopRank(_this.rank_next)
                .then(function (res) {
                _this.rank_next = res.paging.next;
                _this.rank = _this.rank.concat(res.data);
                if (dem === 5) {
                    _this.rank_next = 'mducptit';
                    _this.ranktmp = _this.rank;
                    _this.rank = [];
                    _this.ranktmp.sort(function (a, b) { return b.message_count - a.message_count; });
                    _this.ShowLoading = false;
                }
            })
                .catch(function () {
                clearInterval(intervalSapXep);
                location.reload();
            });
            dem++;
            if (dem === 5) {
        ...
        // this.rank.sort((a,b) => b.message_count - a.message_count);
